...
public struct LKTimetable: Codable {
  ...
  public func fetchedInfo(token: String, _ completion: @escaping ((Result<LKTimetable, Error>) -> Void)) {
    DispatchQueue.global().async {
      ...
      let event = LKTimetable(lesson: fetchedLesson,
